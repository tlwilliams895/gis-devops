...
* Download jenkins war from `jenkins home page <https://jenkins.io/download/>`_ by clicking **Generic Java War**  (note: scroll to the bottom of the page)
Download Jenkins * Generic War
